...
export default function ImageUploader({ label, value, onChange, accept = 'image/*', kind = 'image', endpoint = '/api/uploads', previewClassName = 'h-14 w-14 rounded-sm border border-gold/30 object-cover' }) {
